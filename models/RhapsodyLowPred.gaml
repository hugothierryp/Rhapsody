...
global torus:true { 
	...
	file InitialisationFile <- csv_file('../includes/VCGRHAPSODYLaunchLowPred.csv');	 //Default set of parameters to initialize the simulation
...
///////////////  If not, local dispersion according to movement distances /////////////////////////////	
	...
	action aphid_background_mortality{
		numberApNymphs<-int(numberApNymphs*0.9);
		numberAlNymphs<-int(numberAlNymphs*0.9);
		numberAdults<- int(numberAdults*0.9);		
	}	
